    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        ...
        <div className="i-icons">
         <a href ="https://github.com/swathiravi-vh" target="_blank" ><img src={Github} alt="" /></a> 
         <a href ="https://www.linkedin.com/in/swathi-ravi-28hemi/" target="_blank" ><img src={LinkedIn} alt="" /></a>
        </div>
      </div>
      {/* right image side */}
